...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/11.habilidades/BD_impacto_habilidades.csv"),
    "2026": Path("data/processed/2026/11.habilidades/BD_impacto_habilidades.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/habilidades")
ARCHIVO_SALIDA = CARPETA_SALIDA / "BD_impacto_habilidades.csv"
...
def leer_csv_seguro(ruta: Path, anio: str) -> pd.DataFrame:
    ...
    df = pd.read_csv(ruta, dtype={"DNI__c": str})
    df["ANIO_FUENTE"] = anio
...
# ============================================================
def main():
    print("=== CONSOLIDACIÓN IMPACTO HABILIDADES ===")
