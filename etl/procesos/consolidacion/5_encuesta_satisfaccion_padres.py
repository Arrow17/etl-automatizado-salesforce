...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/5.encuesta_satisfaccion_padres/Encuesta_Padres_Deduplicado.csv"),
    "2026": Path("data/processed/2026/5.encuesta_satisfaccion_padres/Encuesta_Padres_Deduplicado.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/encuesta_satisfaccion_padres")
ARCHIVO_SALIDA = CARPETA_SALIDA / "Encuesta_Padres_Deduplicado.csv"
...
def leer_csv_seguro(ruta: Path, anio: str) -> pd.DataFrame:
    ...
    df = pd.read_csv(ruta, dtype={"N Documento Apoderado": str, "N Documento Niño": str})
    df["ANIO_FUENTE"] = anio
...
def main():
    print("=== CONSOLIDACIÓN ENCUESTA SATISFACCIÓN PADRES ===")
