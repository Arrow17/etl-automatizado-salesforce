...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/8.solicitud_matricula/Sol_Mtr_Deduplicado.csv"),
    "2026": Path("data/processed/2026/8.solicitud_matricula/Sol_Mtr_Deduplicado.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/solicitud_matricula")
ARCHIVO_SALIDA = CARPETA_SALIDA / "Sol_Mtr_Deduplicado.csv"
...
def main():
    print("=== CONSOLIDACIÓN SOLICITUD MATRÍCULA ===")
