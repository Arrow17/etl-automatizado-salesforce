...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/7.progreso_curricular/BD_Curricula_Consolidada.csv"),
    "2026": Path("data/processed/2026/7.progreso_curricular/BD_Curricula_Consolidada.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/progreso_curricular")
ARCHIVO_SALIDA = CARPETA_SALIDA / "BD_Curricula_Consolidada.csv"
...
def main():
    print("=== CONSOLIDACIÓN PROGRESO CURRICULAR ===")
