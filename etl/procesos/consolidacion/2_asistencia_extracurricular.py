...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/asistencias_extracurriculares/asistencias_extra_consolidado_kantaya.csv"),
    "2026": Path("data/processed/2026/asistencias_extracurriculares/asistencias_extra_consolidado_kantaya.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/asistencias_extracurriculares")
ARCHIVO_SALIDA = CARPETA_SALIDA / "asistencias_extra_consolidado_kantaya.csv"
...
def main():
    print("=== CONSOLIDACIÓN ASISTENCIAS EXTRACURRICULARES ===")
