...
# ============================================================
ARCHIVOS_POR_ANIO = {
    "2025": Path("data/processed/2025/matricula/consolidado_matricula_afterschool_2025_UNICO.csv"),
    "2026": Path("data/processed/2026/matricula/consolidado_matricula_afterschool_2026_UNICO.csv"),
}

CARPETA_SALIDA = Path("data/consolidated/matricula")
ARCHIVO_SALIDA = CARPETA_SALIDA / "consolidado_matricula_afterschool.csv"
...
def leer_csv_seguro(ruta: Path, anio: str) -> pd.DataFrame:
    ...
    df = pd.read_csv(ruta, dtype={"DNI DEL NIÑO": str, "DNI DEL NINO": str, "DNI": str})
    df["ANIO_FUENTE"] = anio
