...
ruta_consolidado = "data/consolidated/asistencias_extracurriculares/asistencias_extra_consolidado_kantaya.csv"
...
# ================================================================
# 6️⃣ Limpiar campo CENTRO
# ================================================================
if "CENTRO" in Asistencias.columns:
    Asistencias["CENTRO"] = Asistencias["CENTRO"].astype(str)
    ...
    Asistencias["CENTRO"] = Asistencias["CENTRO"].str.replace(
        " REGISTRO DE ASISTENCIA 2026.xlsx", "", regex=False
    )
...
# ================================================================
# 7️⃣ Reemplazar NaN por None
# ================================================================
Asistencias = Asistencias.where(pd.notnull(Asistencias), None)

# ================================================================
# 8️⃣ Renombrar columnas con sufijo __c
# ================================================================
