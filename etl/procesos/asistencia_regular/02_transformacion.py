...
6) Salida:
   - Formato final: largo por fecha, con las 3 columnas de totales (si existen),
     ...
     y columnas de fecha en formato dd/mm/yyyy.
...
CARPETA = Path("entrada/asistencias")
CARPETA_SALIDA = Path("salida/asistencias")
...
SALIDA = CARPETA_SALIDA / "asistencias_consolidado_kantaya.csv"
SALIDA_CALIDAD = CARPETA_SALIDA / "asistencias_consolidado_kantaya_CALIDAD.xlsx"
...
def main():
    ...
    Flujo principal:
      ...
      6) <-- MODIFICADO: Formatea FECHA, F_INCORPORACION, F_SALIDA (dd/mm/yyyy) y anula errores.
